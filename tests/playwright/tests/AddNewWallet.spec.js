...
(0, test_1.test)('new wallet', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'New Wallet Create new wallet' }).click()];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('heading', { name: 'Generating wallet...' })).toBeVisible()];
                case 4:
                    _b.sent();
                ...
                case 8:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button').nth(2)).toBeVisible()];
                case 9:
                    _b.sent();
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('h2')).toContainText('Grab a pen and a piece of paper')];
                case 12:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('We strongly recommend you')).toBeVisible()];
                case 13:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#react-portal-modal-container')).toContainText('Grab a pen and a piece of paperWe strongly recommend you write down the recovery phrase because it’s the only way to have access to and recover your wallet in case of losing your device. Do not send it to yourself via email or take a screenshot. It’s safer when kept offline.')];
                case 14:
                    _b.sent();
