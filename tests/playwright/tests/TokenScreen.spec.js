...
(0, test_1.test)('TON screen', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, page.getByText('TON').nth(2).click()];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('Toncoin')).toBeVisible()];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^Toncoin$/ }).getByRole('button').first()).toBeVisible()];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('img', { name: 'TON' })).toBeVisible()];
                case 4:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Send' }).nth(2)).toBeVisible()];
                case 5:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Receive' }).nth(1)).toBeVisible()];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Swap' })).toBeVisible()];
                case 7:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Buy' }).nth(1)).toBeVisible()];
                case 8:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('History').nth(1)).toBeVisible()];
                case 9:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^Toncoin$/ }).getByRole('button').nth(1)).toBeVisible()];
                case 10:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Swap' }).click()];
                case 11:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^Swap$/ }).nth(1)).toBeVisible()];
                case 12:
                    _b.sent();
                ...
                case 17:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Buy' }).nth(1).click()];
                case 18:
                    _b.sent();
                ...
                case 20:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Send' }).nth(2).click()];
                case 21:
                    _b.sent();
...
(0, test_1.test)('Jetton screen', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, page.getByText('USD₮').nth(1).click()];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('USD₮', { exact: true })).toBeVisible()];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('img', { name: 'USD₮' })).toBeVisible()];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Send' }).nth(2)).toBeVisible()];
                case 4:
                ...
                case 22:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('USD₮', { exact: true }).nth(2)).toBeVisible()];
                case 23:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('USD₮USD₮0.00 USD')).toBeVisible()];
                case 24:
                    _b.sent();
                    return [4 /*yield*/, page.getByTestId('amount-input').fill('0.0011')];
                case 25:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 26:
