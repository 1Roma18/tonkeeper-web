...
(0, test_1.test)('Incorrect seed phrase ', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, page.getByLabel('1:', { exact: true }).fill(process.env.FAKE_MNEMONIC)];
                case 5:
                    _b.sent();
                ...
                case 8:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('Incorrect phrase')).toBeVisible()];
                case 9:
                    _b.sent();
                    return [4 /*yield*/, page.locator('#react-portal-modal-container').getByRole('button').nth(1).click()];
                case 10:
                    _b.sent();
                ...
                case 12:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#react-portal-modal-container')).toContainText('Continue Editing')];
                case 13:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Discard Changes' })).toBeVisible()];
                case 14:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#react-portal-modal-container')).toContainText('Discard Changes')];
                case 15:
                    _b.sent();
...
(0, test_1.test)('Incorrect password', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, page.getByLabel('1:', { exact: true }).fill(process.env.TON_MNEMONIC_12)];
                case 5:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 6:
                ...
                case 8:
                    _b.sent();
                    return [4 /*yield*/, page.locator('#create-password-confirm').fill('123457')];
                case 9:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 10:
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('form')).toContainText('Passwords do not match.')];
                case 12:
                    _b.sent();
                    return [4 /*yield*/, page.locator('div:nth-child(2) > .sc-gGmKOd').click()];
                case 13:
                    _b.sent();
                    return [4 /*yield*/, page
                ...
                case 15:
                    _b.sent();
                    return [4 /*yield*/, page.locator('#create-password-confirm').fill('1234')];
                case 16:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 17:
                ...
                case 22:
                    _b.sent();
                    return [4 /*yield*/, page.goto('/wallet-settings')];
                case 23:
                    _b.sent();
                    return [4 /*yield*/, page
                            .locator('div')
                ...
                case 24:
                    _b.sent();
                    return [4 /*yield*/, page.getByText('I have a backup copy of recovery phraseBack up now').click()];
                case 25:
                    _b.sent();
                    return [4 /*yield*/, page
                            .locator('div')
