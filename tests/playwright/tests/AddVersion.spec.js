...
(0, test_1.test)('Add /hide version by gear', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, page.getByLabel('1:', { exact: true }).fill(process.env.TON_MNEMONIC_24_2)];
                case 5:
                    _b.sent();
                ...
                case 8:
                    _b.sent();
                    return [4 /*yield*/, page.locator('input[type="password"]').nth(1).click()];
                case 9:
                    _b.sent();
                    return [4 /*yield*/, page.locator('input[type="password"]').nth(1).fill('123456')];
                case 10:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 11:
                    _b.sent();
                    return [4 /*yield*/, page.getByLabel('Wallet name').fill('%Test name%')];
                case 12:
                    _b.sent();
                ...
                case 14:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: '%Test name% UQDJ…SXO9 W5 UQAg…' }).getByRole('button')).toBeVisible()];
                case 15:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: '%Test name% UQDJ…SXO9 W5 UQAg…' }).getByRole('button').click()];
                case 16:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('Version')).toBeVisible()];
                case 17:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#react-portal-modal-container')).toContainText('Version')];
                case 18:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Hide' }).nth(2).click()];
                case 19:
                    _b.sent();
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 12:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Account 1 UQDJ…SXO9 W5 UQAg…' }).getByRole('button').click()];
                case 13:
                    _b.sent();
                ...
                case 15:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('UQDP…-Pi6')];
                case 16:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Account 1 UQDJ…SXO9 W5 UQAg…' })).toBeVisible()];
                case 17:
                    _b.sent();
                    return [4 /*yield*/, page.getByText('Preferences').click()];
                case 18:
...
(0, test_1.test)('Versions via settings', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 9:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('textbox').nth(1).fill('W123*4567')];
                case 10:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 11:
                ...
                case 14:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Add' }).first().click()];
                case 15:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('UQCk…yXNw')];
                case 16:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('v3R2')];
                case 17:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('UQC0…6y4I · 0 TON')];
                case 18:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Add' }).click()];
                case 19:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('UQBP…Hy5i')];
                case 20:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('W5')];
                case 21:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Hide' }).nth(1).click()];
                case 22:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Hide' }).nth(2).click()];
                case 23:
                ...
                case 25:
                    _b.sent();
                    return [4 /*yield*/, page.locator('div').filter({ hasText: /^I have a backup copy of recovery phrase$/ }).click()];
                case 26:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Delete wallet data' }).click()];
                case 27:
