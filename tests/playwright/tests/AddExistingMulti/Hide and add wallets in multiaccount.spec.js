...
(0, test_1.test)('Hide/ add wallets', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, page.getByText('Hide Current Wallet').click()];
                case 12:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('link', { name: 'Settings' }).click()];
                case 13:
                ...
                case 16:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Account 1 Multi Wallet 2 #2' })).toBeVisible()];
                case 17:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('link', { name: 'Settings' }).click()];
                case 18:
