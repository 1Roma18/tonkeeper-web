...
//Add parent wallet
(0, test_1.test)('Add existing multi wallet', function (_a) {
    var page = _a.page;
...
(0, test_1.test)('Child wallet', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    _b.sent();
                    return [4 /*yield*/, page.locator('label').filter({ hasText: /^1:$/ }).click()];
                case 4:
                    _b.sent();
                    return [4 /*yield*/, page.getByLabel('1:', { exact: true }).fill(process.env.TON_MNEMONIC_24_4)];
                case 5:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 6:
