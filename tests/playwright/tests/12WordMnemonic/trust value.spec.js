...
(0, test_1.test)('trust + assert visibility and value', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 14:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('TON').first()).toBeVisible()];
                case 15:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('USD₮')).toBeVisible()];
                case 16:
                    _b.sent();
