...
(0, test_1.test)('2 wallets & bulk delete', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _b.sent();
                    return [4 /*yield*/, page.getByLabel('1:', { exact: true }).fill(process.env.TON_MNEMONIC_24_5)];
                case 5:
                    _b.sent();
                ...
                case 21:
                    _b.sent();
                    return [4 /*yield*/, page.getByText('Sign Out of all Accounts').click()];
                case 22:
                    _b.sent();
                    return [4 /*yield*/, page
                            .locator('div')
