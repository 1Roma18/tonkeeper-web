...
(0, test_1.test)('Add general wallet', function (_a) {
    var page = _a.page;
...
(0, test_1.test)('Add my test wallet & hide version', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 10:
                    _b.sent();
                    return [4 /*yield*/, page.locator('#react-portal-modal-container').getByRole('textbox').fill('My test wallet')];
                case 11:
                    _b.sent();
                ...
                case 17:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'My test wallet UQDJ…SXO9 W5' }).click()];
                case 18:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'My test wallet UQDJ…SXO9 W5' }).click()];
                case 19:
