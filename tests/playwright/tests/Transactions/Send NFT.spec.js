    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, page.locator('#react-portal-modal-container').getByRole('textbox').fill('Test wallet for NFT transfer')];
                case 12:
                    _b.sent();
...
(0, test_1.test)('Transfer NFT', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, page.locator('.sc-gKRSaq').click()];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#react-portal-modal-container').getByText('Moonbirds')).toBeVisible()];
                case 3:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('form')).toContainText('Moonbirds')];
                case 4:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Transfer', exact: true }).click()];
                case 5:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('textbox').first().click()];
                case 6:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('textbox').first().fill('UQDJ3uzSvsW4TGnWfcmBOKpQBqRpMEbwsJJ66ci4bdOISXO9')];
                case 7:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Continue' }).click()];
                case 8:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#react-portal-modal-container')).toContainText('EQCq…k2hS')];
                case 9:
                    _b.sent();
                ...
                case 11:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Confirm' })).toBeVisible()];
                case 12:
                    _b.sent();
                    return [4 /*yield*/, page.getByRole('button', { name: 'Confirm' }).click()];
                case 13:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('Done')).toBeVisible()];
                case 14:
                    _b.sent();
...
(0, test_1.test)('Transfer NFT + pending', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 17:
                    ...
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('Pending')).toBeVisible({ timeout: 40 * 1000 })];
                case 18:
                    // Wait pending transaction transaction in the history tab
                    _b.sent();
                    return [2 /*return*/];
