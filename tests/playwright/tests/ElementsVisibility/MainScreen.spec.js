...
(0, test_1.test)('Main screen', function (_a) {
    var page = _a.page;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 14:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('Ananas')];
                case 15:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByText('UQBA…OP8V').first()).toBeVisible()];
                case 16:
                    _b.sent();
                ...
                case 19:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^AnanasUQBA…OP8VW5$/ }).getByRole('img')).toBeVisible()];
                case 20:
                    _b.sent();
                ...
                case 24:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('Discover')];
                case 25:
                    _b.sent();
                ...
                case 31:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^Add Wallet$/ })).toBeVisible()];
                case 32:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('Add Wallet')];
                case 33:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^Preferences$/ })).toBeVisible()];
                case 34:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('Preferences')];
                case 35:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Get Pro' })).toBeVisible()];
                case 36:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('Get Pro')];
                case 37:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('div').filter({ hasText: /^Add WalletPreferencesGet Pro$/ }).getByRole('button').nth(1)).toBeVisible()];
                case 38:
                    _b.sent();
                ...
                case 42:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('link', { name: 'Swap' })).toBeVisible()];
                case 43:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('link', { name: 'Multisig Wallets' })).toBeVisible()];
                case 44:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('link', { name: 'Tonkeeper Battery' })).toBeVisible()];
                case 45:
                    _b.sent();
                ...
                case 49:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Buy' })).toBeVisible()];
                case 50:
                    _b.sent();
                ...
                case 52:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('button', { name: 'Hide Statistics' })).toBeVisible()];
                case 53:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.locator('#root')).toContainText('Hide Statistics')];
                case 54:
                    _b.sent();
                    return [4 /*yield*/, (0, test_1.expect)(page.getByRole('region').locator('svg')).toBeVisible()];
                case 55:
                    _b.sent();
                    return [2 /*return*/];
            }
