...
exports.KeychainDesktop = void 0;
...
var KeychainDesktop = /** @class */ (function (_super) {
    __extends(KeychainDesktop, _super);
    function KeychainDesktop(biometryService, storage) {
        var _this = _super.call(this, storage) || this;
        _this.biometryService = biometryService;
        _this.setData = function (key, data) { return __awaiter(_this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, backgroudService_1.sendBackground)({ king: 'set-keychain', publicKey: key, mnemonic: data })];
                    case 1:
                        _a.sent();
        ...
        _this.getData = function (key) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, (0, backgroudService_1.sendBackground)({ king: 'get-keychain', publicKey: key })];
                    case 3:
                        value = _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
        ...
        _this.removeData = function (key) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, backgroudService_1.sendBackground)({ king: 'remove-keychain', publicKey: key })];
                    case 1:
                        _a.sent();
        ...
        _this.clearStorage = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, (0, backgroudService_1.sendBackground)({ king: 'clear-keychain' })];
                    case 1:
                        _a.sent();
    ...
    KeychainDesktop.prototype.promptPassword = function (callback) {
        PromptDesktopPassword_1.promptDesktopPasswordController.open({
            afterClose: callback
        });
    };
    KeychainDesktop.prototype.securityCheckTouchId = function () {
        var _a;
    ...
    return KeychainDesktop;
}(base_keychain_service_1.BaseKeychainService));
exports.KeychainDesktop = KeychainDesktop;
