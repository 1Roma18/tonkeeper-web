...
exports.tonConnectSSE = new ton_connect_sse_1.TonConnectSSE({
    storage: storageService_1.mainStorage,
    listeners: {
        onDisconnect: function (params) { return mainWindow_1.MainWindow.mainWindow.webContents.send('disconnect', params); },
        onRequest: function (params) { return mainWindow_1.MainWindow.mainWindow.webContents.send('tonConnectRequest', params); }
    },
    bridgeEndpointFetcher: (0, ton_connect_sse_1.createBridgeEndpointFetcher)({
        platform: 'desktop',
        build: package_json_1["default"].version,
        onError: function (e) { return main_1["default"].error(e); }
    }),
    system: {
        log: main_1["default"],
        refresh: function () { return mainWindow_1.MainWindow.mainWindow.webContents.send('refresh'); },
        bringToFront: function () { return __awaiter(void 0, void 0, void 0, function () {
