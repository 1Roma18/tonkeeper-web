    ...
    function ExtensionStorage() {
        ...
        this.get = function (key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, webextension_polyfill_1["default"].storage.local.get(key).then(function (result) {
                        var _a;
                        var err = (0, utils_1.checkForError)();
                        if (err) {
                            throw err;
                        }
                        return (_a = result[key]) !== null && _a !== void 0 ? _a : null;
                    })];
            });
        }); };
        this.set = function (key, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, webextension_polyfill_1["default"].storage.local.set((_a = {}, _a[key] = payload, _a))];
                    case 1:
                        _b.sent();
                        err = (0, utils_1.checkForError)();
                        if (err) {
                            throw err;
                        }
        ...
        this.setBatch = function (values) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, webextension_polyfill_1["default"].storage.local.set(values)];
                    case 1:
                        _a.sent();
                        err = (0, utils_1.checkForError)();
                        if (err) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, webextension_polyfill_1["default"].storage.local.set((_a = {}, _a[key] = null, _a))];
                    case 2:
                        _b.sent();
                        err = (0, utils_1.checkForError)();
                        if (err) {
        ...
        this.clear = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, webextension_polyfill_1["default"].storage.local.clear()];
                    case 1:
                        _a.sent();
                        err = (0, utils_1.checkForError)();
                        if (err) {
