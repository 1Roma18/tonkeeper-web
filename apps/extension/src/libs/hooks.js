...
exports.useAnalytics = exports.useAppWidth = void 0;
...
var aptabase_extension_1 = require("./aptabase-extension");
...
var useAnalytics = function (config, activeAccount, accounts) {
    var network = (0, wallet_1.useActiveTonNetwork)();
    return (0, react_query_1.useQuery)([
        queryKey_1.QueryKey.analytics,
        activeAccount,
        accounts,
        network,
        config === null || config === void 0 ? void 0 : config.aptabaseEndpoint,
        config === null || config === void 0 ? void 0 : config.aptabaseKey
    ], function () { return __awaiter(void 0, void 0, void 0, function () {
        var tracker;
        return __generator(this, function (_a) {
            if (!(config === null || config === void 0 ? void 0 : config.aptabaseEndpoint) || !(config === null || config === void 0 ? void 0 : config.aptabaseKey) || appSdk_1.extensionType === 'FireFox') {
                return [2 /*return*/];
            }
            tracker = new aptabase_extension_1.AptabaseExtension(config.aptabaseEndpoint, config.aptabaseKey);
            tracker.init({
                application: appSdk_1.extensionType !== null && appSdk_1.extensionType !== void 0 ? appSdk_1.extensionType : 'Extension',
