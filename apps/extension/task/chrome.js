...
function buildChrome() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    builder = new extension_builder_1.ExtensionBuilder('chrome');
                    (0, extension_builder_1.notify)("Create Chrome Build ".concat(builder.version));
