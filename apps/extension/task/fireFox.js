...
exports.buildFirefox = void 0;
var extension_builder_1 = require("./extension-builder");
var updateFireFoxManifest = function (builder) {
    var manifestFFData = builder.readManifest();
...
function buildFirefox() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    builder = new extension_builder_1.ExtensionBuilder('firefox');
                    (0, extension_builder_1.notify)("Create FireFox Build ".concat(builder.version));
