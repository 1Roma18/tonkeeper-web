    ...
    function PreferencesStorage() {
        ...
        this.get = function (key) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, preferences_1.Preferences.get({ key: key })];
                    case 1:
                        value = (_a.sent()).value;
        ...
        this.set = function (key, value) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, preferences_1.Preferences.set({ key: key, value: JSON.stringify(value) })];
                    case 1:
                        _a.sent();
        ...
        this.setBatch = function (values) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        operations = Object.entries(values).map(function (_a) {
                            var key = _a[0], value = _a[1];
                            return preferences_1.Preferences.set({ key: key, value: JSON.stringify(value) });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, preferences_1.Preferences.remove({ key: key })];
                    case 2:
                        _a.sent();
                        _a.label = 3;
        ...
        this.clear = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, preferences_1.Preferences.clear()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.keys = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, preferences_1.Preferences.keys()];
                    case 1:
                        keys = (_a.sent()).keys;
...
exports.PreferencesStorage = PreferencesStorage;
